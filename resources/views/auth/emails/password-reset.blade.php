...
<body style="margin:0; padding:0; background-color:#f6f9fc; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:#33475b;">
    <table width="100%" bgcolor="#f6f9fc" cellpadding="0" cellspacing="0" role="presentation" style="padding: 40px 0;">
        <tr>
            <td align="center">
                <table width="480" bgcolor="#ffffff" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:12px; box-shadow: 0 8px 24px rgba(0,0,0,0.1); padding: 40px;">
                    <tr>
