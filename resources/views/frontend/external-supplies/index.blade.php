    ...
    <div class="card-body">
      <div class="row g-3 align-items-end">
        <div class="col-md-5">
          ...
          <input id="filterClient" type="text" class="form-control form-control-lg" placeholder="es. Steel Reilly">
        </div>
        <div class="col-md-5">
            ...
            <table class="table table-sm table-hover">
              <thead class="table-light">
                <tr>
                  ...
                  <th class="text-end">Costo Riga (€)</th>
                  ...
                  @php
                    $groupedLines = collect($entry['lines'])
                      ...
                      ->map(fn($g) => (object)[
                        ...
                        'cost'    => ($g->first()->recipe->production_cost_per_kg ?? 0)/1000 * $g->sum('qty'),
                      ]);
                  @endphp
